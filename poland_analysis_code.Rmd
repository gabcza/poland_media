...
Compares control conditions, i.e., pure control and TVN source with any topic (general, on-topic, and off-topic) both for blind and revealed conditions; and treatment conditions, i.e., TVP source with on-topic topics and both blind and revealed conditions.

```{r}
# creates condition var for ANOVA
dat <- dat %>%
